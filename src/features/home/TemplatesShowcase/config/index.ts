...
export const getTemplates = (): Template[] => {
  const q = (service: string) =>
    `/request-a-quote?service=${encodeURIComponent(service)}`;
  ...
  return [
    {
      ...
      url: q("Floor Repair"),
      features: ["Fast inspection & repair", "Fix cracks, gaps & uneven areas"],
    },
    {
      id: 2,
